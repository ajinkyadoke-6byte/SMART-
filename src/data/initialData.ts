...
export const INITIAL_PAST_SESSIONS: any[] = [
  {
    id: 'SES-PAST-101',
    sessionId: 'SES-PAST-101',
    sessionCode: 'CS401-8492',
    classId: 'class-cse-a',
    className: 'CSE-A (Semester 4)',
    subjectId: 'sub-ds',
    ...
    students: [
      {
        ...
        rollNo: '22CS001',
        name: 'Aarav Sharma',
        email: 'aarav.sharma.001@attendit.edu',
        avatar: 'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?q=80&w=120&auto=format&fit=crop',
        classId: 'class-cse-a',
        className: 'CSE-A (Semester 4)',
        ...
        status: 'present',
        markedAt: '09:03 AM',
        verificationMethod: 'BLE & Dynamic QR Scan',
      },
      {
        id: 'std-class-cse-a-2',
        rollNo: '22CS002',
        name: 'Ananya Iyer',
        email: 'ananya.iyer.002@attendit.edu',
        avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=120&auto=format&fit=crop',
        classId: 'class-cse-a',
        className: 'CSE-A (Semester 4)',
      ...
      },
      {
        ...
        rollNo: '22CS003',
        name: 'Devansh Verma',
        email: 'devansh.verma.003@attendit.edu',
        avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?q=80&w=120&auto=format&fit=crop',
        classId: 'class-cse-a',
        className: 'CSE-A (Semester 4)',
        ...
        status: 'flagged',
        markedAt: '09:08 AM',
        flagReason: 'QR scan token timestamp jitter anomaly (>15s)',
      },
      {
        id: 'std-class-cse-a-4',
        rollNo: '22CS004',
        name: 'Ishita Patel',
        email: 'ishita.patel.004@attendit.edu',
        avatar: 'https://images.unsplash.com/photo-1517841905240-472988babdf9?q=80&w=120&auto=format&fit=crop',
        classId: 'class-cse-a',
        className: 'CSE-A (Semester 4)',
      ...
      },
      {
        ...
        rollNo: '22CS005',
        name: 'Karan Malhotra',
        email: 'karan.malhotra.005@attendit.edu',
      ...
      },
      {
        ...
        rollNo: '22CS006',
        name: 'Meera Nair',
        email: 'meera.nair.006@attendit.edu',
        avatar: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=120&auto=format&fit=crop',
        classId: 'class-cse-a',
        className: 'CSE-A (Semester 4)',
  ...
  {
    id: 'SES-PAST-102',
    sessionId: 'SES-PAST-102',
    sessionCode: 'CS402-9182',
    classId: 'class-cse-b',
    className: 'CSE-B (Semester 4)',
    subjectId: 'sub-dbms',
    subjectName: 'Database Management Systems',
    ...
    students: [
      {
        ...
        status: 'present',
        markedAt: '10:17 AM',
        verificationMethod: 'Dynamic QR Scan',
      },
      {
        id: 'std-cse-b-2',
        rollNo: '22CS042',
        name: 'Pooja Hegde',
        email: 'pooja.h@attendit.edu',
        avatar: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=120&auto=format&fit=crop',
        classId: 'class-cse-b',
        className: 'CSE-B (Semester 4)',
  ...
  {
    id: 'SES-PAST-103',
    sessionId: 'SES-PAST-103',
    sessionCode: 'IT601-3421',
    classId: 'class-it-a',
    className: 'IT-A (Semester 6)',
    subjectId: 'sub-cn',
    subjectName: 'Computer Networks',
    subjectCode: 'IT601',
    room: 'Room 202 (West Wing)',
    date: 'Aug 19, 2026',
    timeSlot: '09:00 AM - 10:00 AM',
    teacherId: 'teacher-101',
    teacherName: 'Prof. Anjali Sharma',
